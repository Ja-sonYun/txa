...
const remindersCore_1 = require("./reminders/remindersCore");
// (async () => {
//   await run(() => {
...
(async () => {
    ...
    // });
    // console.log(result);
    result = await (0, remindersCore_1.accessReminderOsascript)("get_todo_by_key", {
        list_name: "GitHub",
        key: "id",
    ...
    console.log(result);
    //
    result = await (0, remindersCore_1.accessReminderOsascript)("update_existing_todo", {
        list_name: "GitHub",
